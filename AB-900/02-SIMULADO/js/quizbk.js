...
finalizarBtn.onclick = () => finalizarSimulado();
...
function refazerSimulado() {
  location.reload(); // Mais rápido: recarrega a página e reseta tudo
}
...
function revisarQuestoes() {
  ...
  quiz.innerHTML = "<h2>Revisão de Questões</h2>";
...
`;
  ...
  botoesContainer.className = 'botoes-revisao'; // 🛠️ Novo container padrão
  
  botoesContainer.innerHTML = `
    <center><button id="refazerBtn" class="btn-reiniciar">Refazer Simulado</button>
    <button id="voltarResultadoBtn" class="btn-revisar">Voltar Resultado Final</button></center>
  `;
