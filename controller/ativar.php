...
$stmt = $mysqli->prepare("UPDATE usuarios SET ativo = 1, token_ativacao = NULL WHERE token_ativacao = ?");
...
if ($stmt->affected_rows > 0) {
    echo "<div class='resp-box sucesso'>Usuário ativado com sucesso!</div>";
} else {
    echo "<div class='resp-box erro'>Token inválido ou usuário já ativado.</div>";
}
echo "</body></html>";
