...
<!-- ==========================================
Arquivo: index.html
Descrição: Página principal do Simulado MS-900
========================================== -->
<!DOCTYPE html>
<html lang="pt-BR">
...
<body>
  ...
  <div class="container">
    ...
    <div class="sidebarDireita">
      <center>
        <ul id="listaSimulados">MS-900</ul>
      </center>
  ...
  <script>
    ...
    fetch('/certiacademy/course/MS-900/api/list_simulations.php')
      .then(resp => resp.json())
      .then(simulados => {
