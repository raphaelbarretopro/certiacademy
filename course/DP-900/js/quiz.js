// ==========================================
// Arquivo: quiz.js
// Descrição: Controle principal do Simulado DP-900
// ==========================================
...
export async function carregarQuestoes() {
  ...
  const resp = await fetch(`/certiacademy/course/DP-900/api/questions.php?simulado=${encodeURIComponent(simulado)}`);
