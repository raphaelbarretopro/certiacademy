...
<!-- ==========================================
Arquivo: index.html
Descrição: Página principal do Simulado PL-900
========================================== -->
<!DOCTYPE html>
<html lang="pt-BR">
...
<body>
  ...
  <div class="container">
    ...
    <div class="sidebarDireita">
      <center>
        <ul id="listaSimulados">PL-900</ul>
      </center>
  ...
  <script>
    ...
    fetch('/certiacademy/course/PL-900/api/list_simulations.php')
      .then(resp => resp.json())
      .then(simulados => {
