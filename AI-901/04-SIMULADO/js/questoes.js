...
export const questoes = [
  // Questão Original: 97
  {
    ...
    "afirmacoes": ["Você pode implantar um modelo base suportado diretamente do catálogo de modelos sem modificações.", "O playground é usado obrigatoriamente para criar a implantação do modelo antes que ele possa ser testado.", "Após implantar um modelo, você pode usar o playground no portal do Microsoft Foundry para enviar prompts e revisar as respostas."],
    "respostas": [true, false, true],
    "explicacao": "Você implanta modelos baseados no catálogo diretamente. O Playground é uma ferramenta de teste, não a ferramenta de criação da implantação. O Playground usa a implantação ativa para testar os prompts.",
  ...
  // Questão Original: 99
  {
    ...
    "opcoes": ["Selecione uma opção", "Extração de frases-chave (Key phrase extraction)", "Detecção de idioma (Language detection)", "Reconhecimento de Entidades Nomeadas (NER)", "Análise de Sentimentos (Sentiment Analysis)"],
    "resposta": 3,
    "explicacao": "A extração categórica de nomes, locais, quantidades e datas de um texto não estruturado é a tarefa de Reconhecimento de Entidades Nomeadas (NER).",
  ...
  // Questão Original: 100
  {
    ...
    "opcoes": ["O dataset de treinamento, o histórico do playground e o nome do projeto.", "O histórico do playground, a URL do ponto de extremidade e o tipo de tarefa.", "As credenciais de autenticação, a URL do ponto de extremidade (endpoint URL) e o nome da implantação do modelo.", "O nome de exibição do projeto, o dataset de treinamento e o tipo de tarefa."],
    "resposta": 2,
  ...
  // Questão Original: 101
  {
    ...
    "opcoes": ["Criar miniaturas temporais para vídeos de treinamento.", "Extrair frases-chave de documentos puramente textuais.", "Identificar raças específicas de animais em fluxos de vídeo ao vivo.", "Extrair dados textuais legíveis de cartas manuscritas."],
    "resposta": 3,
    "explicacao": "A leitura de letras cursivas manuscritas em imagens e a sua transformação em strings digitais é a funcionalidade de Reconhecimento Óptico de Caracteres (OCR / Read API), núcleo do serviço Azure Vision.",
  ...
  // Questão Original: 102
  {
    ...
    "opcoes": ["Tradução (Translation)", "Detecção de idioma (Language detection)", "Reconhecimento de entidades (Entity recognition)", "Extração de frases-chave (Key phrase extraction)"],
    "resposta": 3,
    "explicacao": "A extração de frases-chave isola os termos e jargões mais relevantes e repetidos dentro de um texto, permitindo mapear rapidamente as métricas e os tópicos principais de discussão.",
  ...
  // Questão Original: 103
  {
    ...
    "opcoes": ["Privacidade e segurança", "Confiabilidade e segurança", "Imparcialidade (Fairness)", "Transparência"],
    "resposta": 3,
  ...
  // Questão Original: 104
  {
    ...
    "opcoes": ["Provisionada (Provisioned Throughput)", "Padrão (Standard)", "Lote Global (Global Batch)", "Padrão de Zona de Dados (Data Zone Standard)"],
    "resposta": 0,
    "explicacao": "Para garantir latência consistente e um processamento de tokens por minuto (TPM) isolado e reservado, deve-se comprar e usar a implantação de Taxa de Transferência Provisionada (Provisioned Throughput).",
  ...
  // Questão Original: 105
  {
    ...
    "opcoes": ["Transparência", "Responsabilidade", "Imparcialidade", "Inclusão"],
    "resposta": 0,
  ...
  // Questão Original: 106
  {
    ...
    "opcoes": ["Segurança (Safety)", "Confiabilidade (Reliability)", "Imparcialidade (Fairness)", "Privacidade e segurança (Privacy and security)"],
    "resposta": 2,
    "explicacao": "O princípio de Imparcialidade (Fairness) dita que os sistemas de IA devem tratar todas as pessoas de forma equitativa e as avaliações devem garantir que o algoritmo não desenvolva discriminações demográficas.",
    "link": "https://learn.microsoft.com/pt-br/azure/machine-learning/concept-responsible-ai",
    "dominio": "Identificar os conceitos e os recursos de IA",
    "simulado": "ai901-bloco04"
  },
  // Questão Original: 107
  {
    ...
    "afirmacoes": ["Os modelos Whisper no Azure OpenAI são usados exclusivamente para gerar vetores semânticos.", "Os modelos de Embedding no Azure OpenAI são usados para converter texto em matrizes de vetores numéricos.", "Os modelos GPT-4.1 no Azure OpenAI são usados ativamente para gerar imagens originais baseadas em prompts de linguagem natural."],
    "respostas": [false, true, false],
    "explicacao": "O Whisper é o modelo para reconhecimento de fala e transcrição. Modelos de embedding criam vetores para buscas semânticas RAG. Os modelos para gerar imagens são da família DALL-E.",
  ...
  // Questão Original: 108
  {
    ...
    "opcoes": ["Selecione uma opção", "visão computacional (computer vision)", "extração de informações (information extraction)", "processamento de linguagem natural (NLP)", "mineração de conhecimento (knowledge mining)"],
    "resposta": 1,
  ...
  // Questão Original: 109
  {
    ...
    "itens": [{ "label": "Imparcialidade (Fairness)" }, { "label": "Privacidade e Segurança (Privacy and Security)" }, { "label": "Transparência (Transparency)" }],
    "grupos": ["O sistema não deve discriminar decisões com base em gênero, raça ou idade.", "Dados pessoais rastreáveis devem ser visíveis apenas para usuários aprovados na rede.", "Processos de tomada de decisão automatizados devem ser registrados para que usuários aprovem e identifiquem por que uma decisão foi tomada."],
    "respostas": {
      "O sistema não deve discriminar decisões com base em gênero, raça ou idade.": ["Imparcialidade (Fairness)"],
    ...
    "explicacao": "Não discriminar e evitar vieses demográficos = Imparcialidade. Limitar visibilidade a usuários aprovados = Privacidade. Registrar as decisões para rastreabilidade = Transparência.",
    "link": "https://learn.microsoft.com/pt-br/azure/machine-learning/concept-responsible-ai",
    "dominio": "Identificar os conceitos e os recursos de IA",
    "simulado": "ai901-bloco04"
  },
  // Questão Original: 110
  {
    ...
    "opcoes": ["Selecione uma opção", "analisar imagens para classificar e detectar objetos", "criar conteúdo visual e artes novas baseadas em prompts de texto", "organizar dados numéricos estruturados em categorias preditivas clássicas", "usar correspondência de padrões e expressões regulares para estruturar JSON"],
    "resposta": 1,
  ...
  // Questão Original: 111
  {
    ...
    "opcoes": ["IA generativa (Generative AI)", "Inteligência de Documentos (Document Intelligence)", "Visão computacional (Computer vision)", "Processamento de linguagem natural (Natural language processing)"],
    "resposta": 0,
  ...
  // Questão Original: 112
  {
    ...
    "opcoes": ["Detecção de objetos (Object detection)", "Análise de texto (Text analysis)", "Reconhecimento óptico de caracteres (OCR)", "Descrição de imagens (Image description)"],
    "resposta": 2,
  ...
  // Questão Original: 113
  {
    ...
    "opcoes": ["Opinionatedness (Opinatividade)", "Decisiveness (Capacidade de decisão)", "Fairness (Imparcialidade)", "Reliability and safety (Confiabilidade e segurança)", "Inclusiveness (Inclusão)", "Knowledgeability (Nível de conhecimento)"],
    "respostas": [2, 3, 4],
    "explicacao": "Os 6 princípios oficiais da Microsoft são: Imparcialidade (Fairness), Confiabilidade e Segurança (Reliability and safety), Privacidade e Segurança (Privacy and security), Inclusão (Inclusiveness), Transparência (Transparency) e Responsabilidade (Accountability).",
    "link": "https://learn.microsoft.com/pt-br/azure/machine-learning/concept-responsible-ai",
    "dominio": "Identificar os conceitos e os recursos de IA",
    "simulado": "ai901-bloco04"
  },
  // Questão Original: 114
  {
    ...
    "opcoes": ["Selecione uma opção", "imparcialidade (fairness)", "confiabilidade e segurança (reliability and safety)", "responsabilidade (accountability)", "inclusão (inclusiveness)"],
    "resposta": 2,
    "explicacao": "Em cenários onde a falha do algoritmo pode resultar em danos físicos à saúde ou ao patrimônio do usuário, o princípio de Confiabilidade e Segurança exige testes rígidos para mitigar comportamentos inesperados do modelo.",
    "link": "https://learn.microsoft.com/pt-br/azure/machine-learning/concept-responsible-ai",
    "dominio": "Identificar os conceitos e os recursos de IA",
    "simulado": "ai901-bloco04"
  },
  // Questão Original: 115
  {
    ...
    "opcoes": ["uma solução isolada de análise de sentimentos", "um aplicativo de visão computacional", "um agente conversacional (agent / copilot)", "um modelo estático de aprendizado de máquina tabular"],
    "resposta": 2,
  ...
  // Questão Original: 116
  {
    ...
    "opcoes": ["Selecione uma opção", "visão computacional", "processamento de linguagem natural (PNL)", "previsão estatística (forecasting)", "extração de metadados de imagem"],
    "resposta": 2,
    "explicacao": "Sempre que o núcleo computacional de uma solução requer o entendimento e a geração da semântica da linguagem humana, a disciplina fundamental sendo empregada é o Processamento de Linguagem Natural.",
  ...
  // Questão Original: 117
  {
    ...
    "afirmacoes": ["Todos os modelos de IA, sem exceção, podem analisar e gerar saídas de imagens contextuais.", "Um modelo de IA generativa multimodal pode interpretar nativamente uma entrada de imagem dentro do prompt fornecido pelo usuário.", "Um modelo multimodal permite projetar esquemas que combinem tokens de blocos de texto e matrizes de imagens na mesma requisição simultânea."],
    "respostas": [false, true, true],
    "explicacao": "A grande maioria dos modelos preditivos lida exclusivamente com matrizes tabulares ou vetores textuais (afirmação 1 falsa). O termo 'Multimodal' refere-se especificamente à capacidade arquitetônica do modelo de absorver e combinar diferentes naturezas de mídia de forma nativa e simultânea.",
    "link": "https://learn.microsoft.com/pt-br/azure/ai-services/openai/how-to/gpt-with-vision",
    "dominio": "Identificar os conceitos e os recursos de IA",
    "simulado": "ai901-bloco04"
  },
  // Questão Original: 118
  {
    ...
    "opcoes": ["Criar uma transcrição em texto de uma reunião corporativa ou chamada telefônica gravada.", "Um sistema de entretenimento de carro que lê em voz alta as mensagens de texto recebidas pelo motorista.", "Criar um sistema automatizado de anúncios de plataforma e atrasos para uma estação de trem.", "Fornecer legendas ocultas (closed captions) automatizadas para vídeos gravados ou transmissões ao vivo."],
    "respostas": [0, 3],
    "explicacao": "O reconhecimento de fala atua 'escutando' ondas sonoras para transformá-las em texto (Speech-to-Text). Gerar atas de reunião e legendar vídeos são as aplicações diretas disso.",
  ...
  // Questão Original: 119
  {
    ...
    "opcoes": ["Tradução (Translation)", "Reconhecimento de fala (Speech recognition)", "Modelagem de linguagem (Language modeling)", "Síntese de fala (Speech synthesis / Text-to-speech)"],
    "resposta": 3,
  ...
  // Questão Original: 120
  {
    ...
    "opcoes": ["Garantir juridicamente que os desenvolvedores sejam os únicos responsabilizados pelas soluções autônomas que criam.", "Garantir matematicamente que as oportunidades, como empréstimos, sejam alocadas de forma igualitária a todos os solicitantes.", "Ajudar os usuários corporativos e finais a entender os limites da inteligência e como as decisões são processadas pelo sistema de IA.", "Garantir através de chaves que os dados privilegiados dos usuários sejam armazenados de forma criptografada."],
    "resposta": 2,
  ...
  // Questão Original: 121
  {
    ...
    "opcoes": ["Selecione uma opção", "Azure Language (Linguagem)", "Azure Speech (Fala)", "Azure Vision (Visão Computacional)", "Azure OpenAI (Modelos Fundacionais)"],
    "resposta": 2,
    "explicacao": "O Azure Speech Service é o conjunto dedicado de APIs da Microsoft especializado no processamento de sinais de áudio, executando tanto Speech-to-Text quanto Text-to-Speech.",
  ...
  // Questão Original: 122
  {
    ...
    "opcoes": ["Confiabilidade e segurança (Reliability and safety)", "Transparência (Transparency)", "Responsabilidade (Accountability)", "Imparcialidade (Fairness)"],
    "resposta": 3,
    "explicacao": "O viés algorítmico, o preconceito racial e a discriminação de gênero resultam em tratamentos não equitativos. A obrigação ética de mitigar e resolver essas disparidades é governada pelo princípio de Imparcialidade (Fairness).",
    "link": "https://learn.microsoft.com/pt-br/azure/machine-learning/concept-responsible-ai",
    "dominio": "Identificar os conceitos e os recursos de IA",
    "simulado": "ai901-bloco04"
  },
  // Questão Original: 123
  {
    ...
    "itens": [{ "label": "Azure Machine Learning designer" }, { "label": "Automated Machine Learning (AutoML)" }, { "label": "Azure Machine Learning workspace" }, { "label": "Notebooks" }],
    "grupos": ["Fornece um ambiente para profissionais escreverem e executarem código Python diretamente no navegador (browser-based).", "Permite construir rotinas visuais de treinamento usando uma interface gráfica de arrastar e soltar (drag-and-drop).", "Itera automaticamente por diversos algoritmos e hiperparâmetros na nuvem para encontrar o melhor modelo possível.", "Atua como o espaço unificado e centralizado na nuvem para agrupar e gerenciar todos os recursos e artefatos de IA do projeto."],
    "respostas": {
  ...
  // Questão Original: 124
  {
    ...
    "opcoes": ["A disponibilidade regional e cota de processamento do modelo.", "O limite individual de token da janela de contexto da rede neural.", "O suporte a chamadas REST API padrão do serviço.", "O método técnico de autenticação exigido pela aplicação frontend."],
    "resposta": 0,
    "explicacao": "Diferentes datacenters globais têm hardwares de GPU distintos. A implantação falhará imediatamente se o modelo fundacional escolhido não estiver disponível (Availability) na região do Azure na qual o projeto está hospedado.",
    "link": "https://learn.microsoft.com/pt-br/azure/ai-services/openai/concepts/models",
    "dominio": "Implementar soluções de IA usando Microsoft Foundry",
    "simulado": "ai901-bloco04"
  },
  // Questão Original: 125
  {
    ...
    "opcoes": ["Selecione uma opção", "analisar as matrizes de pixels em imagens para classificar cenas e detectar objetos", "criar conteúdo visual do zero (geração) baseado estritamente em descrições de texto", "organizar colunas de dados numéricos estruturados em categorias preditivas matemáticas", "usar correspondência rígida de padrões para recuperar imagens idênticas a partir de um banco de dados relacional"],
    "resposta": 1,
    "explicacao": "A Visão Computacional analisa imagens existentes do mundo real para inferir significado por meio da extração espacial de características, como reconhecimento facial, detecção de objetos de segurança e classificação de cenários.",
    "link": "https://learn.microsoft.com/pt-br/azure/ai-services/computer-vision/overview",
    "dominio": "Identificar os conceitos e os recursos de IA",
    "simulado": "ai901-bloco04"
  },
  // Questão Original: 126
  {
    ...
    "afirmacoes": ["O serviço de síntese de fala (Speech Synthesis) converte fluxos de áudio falados por usuários em formatos de texto digital escrito.", "O serviço de reconhecimento de fala (Speech Recognition) tem a capacidade contínua de detectar e transcrever a entrada fonética falada via microfone.", "O recurso nativo de conversão de texto em fala (Text-to-Speech) isolado tem o objetivo arquitetural de ler um texto em inglês e emitir um áudio falado traduzido em espanhol em tempo real."],
    "respostas": [false, true, false],
    "explicacao": "A síntese faz texto-para-áudio (afirmação 1 falsa). O reconhecimento faz áudio-para-texto (afirmação 2 verdadeira). O fluxo lógico de tradução exige o encadeamento prévio do Azure Translator ou o uso da API de Speech Translation (afirmação 3 falsa).",
    "link": "https://learn.microsoft.com/pt-br/azure/ai-services/speech-service/speech-to-text",
    "dominio": "Identificar os conceitos e os recursos de IA",
    "simulado": "ai901-bloco04"
  },
  // Questão Original: 127
  {
    ...
    "opcoes": ["Responsabilidade (Accountability)", "Confiabilidade e segurança (Reliability and safety)", "Imparcialidade (Fairness)", "Inclusão (Inclusiveness)"],
    "resposta": 3,
    "explicacao": "A acessibilidade física (como acomodar leitores de tela ou comandos de acessibilidade alternativos para limitações cognitivas/motoras) pertence estritamente ao princípio da Inclusão (Inclusiveness).",
    "link": "https://learn.microsoft.com/pt-br/azure/machine-learning/concept-responsible-ai",
    "dominio": "Identificar os conceitos e os recursos de IA",
    "simulado": "ai901-bloco04"
  },
  // Questão Original: 128
  {
    ...
    "opcoes": ["Selecione uma opção", "visão computacional", "processamento de linguagem natural (PNL)", "previsão e mineração de dados em lote", "síntese fonética direcional"],
    "resposta": 2,
