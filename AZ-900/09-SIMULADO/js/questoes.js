...
export const questoes = [
  ...
  // Questao 10 (banco original Q167)
  {
    ...
    "opcoes": ["Sim", "Não"],
    "resposta": 1,
    "explicacao": "O computador tem o PowerShell Core 6.0, mas não tem a Azure CLI instalada, e a questão não menciona isso. Você precisa do módulo Azure PowerShell além do PowerShell para executar comandos do Azure, como o New-AzVM. Portanto, a resposta é Não. O PowerShell Core 6.0 não traz o módulo Azure PowerShell por padrão — é necessário instalar o módulo Azure PowerShell separadamente após instalar o PowerShell Core 6.0 no Mac.",
  ...
  // Questao 44 (banco original Q443)
  {
    ...
    "opcoes": [
      ...
      "um computador que executa o Linux e tem as ferramentas da Azure CLI instaladas",
      "um computador que executa o macOS e tem o PowerShell Core 6.0 e o módulo Azure PowerShell instalados",
      "um computador que executa o Chrome OS e usa o Azure Cloud Shell",
      "um computador que executa o Windows 10 e tem o módulo Azure PowerShell instalado"
    ],
    "respostas": [2, 3, 4],
    "explicacao": "C. Um computador que executa o macOS e tem o PowerShell Core 6.0 e o módulo Azure PowerShell instalados. O PowerShell Core 6.0 é multiplataforma e pode ser executado no macOS; com o módulo Azure PowerShell instalado, esse computador pode executar o script que cria recursos do Azure.\n\nD. Um computador que executa o Chrome OS e usa o Azure Cloud Shell. O Azure Cloud Shell oferece suporte tanto a Bash quanto a PowerShell — se o Cloud Shell estiver configurado para usar PowerShell, ele pode executar o script.\n\nE. Um computador que executa o Windows 10 e tem o módulo Azure PowerShell instalado. O Windows 10 oferece suporte ao PowerShell, e com o módulo Azure PowerShell instalado, ele pode executar o script para criar recursos do Azure.\n\nAs opções com a Azure CLI não servem: nenhuma delas instala o módulo Azure PowerShell, que é o que um script do PowerShell usa para criar recursos do Azure. E o PowerShell sozinho, sem o módulo, também não basta — é por isso que a opção do macOS precisa citar o módulo.",
    "link": "https://learn.microsoft.com/pt-br/powershell/azure/what-is-azure-powershell",
    "dominio": "Descrever o gerenciamento e a governança do Azure",
    "simulado": "az-2026-bloco09"
  },
