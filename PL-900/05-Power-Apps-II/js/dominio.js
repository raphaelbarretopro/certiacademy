...
const dominiosOficiais = [
  "Descrever o valor de negócios do Microsoft Power Platform",
  "Identificar os componentes básicos do Microsoft Power Platform",
  "Demonstrar as funcionalidades do Power BI",
  "Demonstrar as funcionalidades do Power Apps",
  "Demonstrar os recursos do Power Automate",
  "Demonstrar as funcionalidades do Power Pages",
  "Descrever a experiência de criação de IA no Microsoft Power Platform"
];
